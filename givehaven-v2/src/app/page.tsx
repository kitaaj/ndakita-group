        ...
        {!showGiveHaven ? (
          ...
          >
            ...
            <motion.button
              ...
              className="fixed top-6 left-6 z-50 flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 backdrop-blur-md text-white/80 hover:text-white hover:bg-white/20 transition-all duration-300 text-sm font-semibold"
